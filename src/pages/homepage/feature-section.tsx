...
const features = [
	{
		...
		description:
			"Conecte-se com colegas de curso, professores, tecnicos do IFCE. Amplie sua rede de contatos academicos",
	},
	...
	},
	{
		...
		description:
			"Celebre seus resultados academicos, certificações e premios com toda a comunidade institucional",
	},
	{
		icons: BookOpen,
			...
			<div className="container-main">
				...
				<div className="grid grid-cols-4 gap-6 mt-16">
					{features.map((feature) => (
						<Card
							key={feature.title}
							className="border-border bg-card houver:border-primary/30 houver:shadow-md transition-all duration-200"
						>
