...
const faq = [
	{
		...
		answer:
			"Todos os membros da comunidade IFCE: alunos, professores, técnicos admnistrativos e egressos.",
	},
	{
		question: "Como funciona a formação de grupos de estudos?",
		answer:
			"Você pode criar um grupo de estudo sobre qualquer tema, convidar membros e compartilhar materiais.",
	},
	{
		question: "Posso divulgar meu projeto de pesquisa?",
		answer:
			"Sim! A plataforma possui área dedicada para publicação de projetos e pesquisas, extensão e inovação.",
	},
	{
	...
	},
	{
		...
		answer:
			"As badges são reconhecimentos visuais do seu papel e conquistas na instituição",
	},
];
